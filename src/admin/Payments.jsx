          ...
          <table className="w-full text-sm" data-testid="payments-table">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Reserva</th>
            ...
            <tbody>
              {items.map((p) => (
                <tr key={p.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50">
                  <td className="px-6 py-3 text-gray-900 font-medium">{p.client_name}</td>
                  <td className="px-6 py-3 text-gray-700">{p.reservation_destination}</td>
                  <td className="px-6 py-3 text-gray-600">{formatDate(p.payment_date || p.created_at)}</td>
                  <td className="px-6 py-3 text-gray-900">{formatCurrency(p.amount)}</td>
                  <td className="px-6 py-3 text-gray-700 capitalize">{p.method}</td>
