...
const STYLES = {
  ...
  inactivo: "bg-gray-100 dark:bg-[#132D52] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-[#1A3356]",
  borrador: "bg-gray-100 dark:bg-[#132D52] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-[#1A3356]",
  ...
  finalizada: "bg-gray-100 dark:bg-[#132D52] text-gray-700 dark:text-gray-300 border-gray-200 dark:border-[#1A3356]",
...
export default function StatusBadge({ value, testId }) {
  const cls = STYLES[value] || "bg-gray-100 dark:bg-[#132D52] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-[#1A3356]";
